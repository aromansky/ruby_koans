...
class AboutStrings < Neo::Koan
  def test_double_quoted_strings_are_strings
    string = "Hello, World"
    assert_equal "Hello, World".is_a?(String), string.is_a?(String)
  end

  def test_single_quoted_strings_are_also_strings
    string = 'Goodbye, World'
    assert_equal 'Goodbye, World'.is_a?(String), string.is_a?(String)
  end
  ...
  def test_use_backslash_for_those_hard_cases
    a = "He said, \"Don't\""
    b = 'He said, "Don\'t"'
    assert_equal "He said, \"Don't\"" == 'He said, "Don\'t"', a == b
  end
